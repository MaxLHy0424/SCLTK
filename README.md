...
| SCLTK (CRCSN) 6 | [v6.3.3](https://github.com/MaxLHy0424/SCLTK/releases/tag/v6.3.3)           | ✅ 基线开发 | 2025-01-29/..         |
...
- **内存占用优化 \(下次启动时生效\)**\
  每 5s 向操作系统申请回收 SCLTK 内存. 可以极大减少物理内存占用, 但会对 SCLTK 整体性能产生负面影响, 并可能增加 CPU 资源和硬盘资源消耗. SCLTK 下次启动时生效.
- **禁用非实时热重载 \(下次启动时生效\)**\
