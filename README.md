...
> 当前 SCLTK 最新正式发行版和最新预览版可从 [SCLTK & SCLTK-Legacy 下载站](https://scltk.maxlhy0424.is-a.dev) 获取。如需自定部署，请转到 [SCLTK-Website-Template](https://github.com/MaxLHy0424/SCLTK-Website-Template)。
...
- **置顶窗口**\
  每 50ms 强制显示窗口并设为置顶。
- **随机标题**\
  运行时动态生成窗口标题，可在一定程度上绕过部分电子教室软件的封杀。
