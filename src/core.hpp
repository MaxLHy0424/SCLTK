...
namespace core
{
    ...
    static_assert( default_thread_sleep_time.count() > 0, "'default_thread_sleep_time' must be greater than 0" );
    static_assert( default_execution_sleep_time.count() > 0, "'default_execution_sleep_time' must be greater than 0" );
