      ...
      public:
        auto operator()()
        {
            ...
            switch ( op_mode ) {
                case mode::crack :
                    std::invoke(
                      std::array{ &operation::default_crack_engine_, &operation::fast_crack_engine_ }[ details::is_enable_fast_mode ],
                      *this );
                    break;
                case mode::restore :
                    std::invoke(
                      std::array{
                        &operation::default_restore_engine_, &operation::fast_restore_engine_ }[ details::is_enable_fast_mode ],
                      *this );
                    break;
            }
