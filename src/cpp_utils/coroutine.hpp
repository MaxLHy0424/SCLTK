...
namespace cpp_utils
{
    ...
    {
      public:
        using promise_type = ____details::coroutine_promise< R, coroutine >;
      private:
        using handle_ = std::coroutine_handle< promise_type >;
        handle_ coroutine_handle_{};
      public:
        using iterator = ____details::coroutine_iterator< handle_ >;
    ...
    {
      public:
        using promise_type = ____details::coroutine_promise< void, coroutine >;
      private:
        using handle_ = std::coroutine_handle< promise_type >;
        handle_ coroutine_handle_{};
      public:
    ...
    {
      public:
        using promise_type = ____details::coroutine_promise_noexcept< R, coroutine_noexcept >;
      private:
        using handle_ = std::coroutine_handle< promise_type >;
        handle_ coroutine_handle_{};
      public:
    ...
    {
      public:
        using promise_type = ____details::coroutine_promise_noexcept< void, coroutine_noexcept >;
      private:
        using handle_ = std::coroutine_handle< promise_type >;
        handle_ coroutine_handle_{};
      public:
