...
namespace scltk
{
    ...
    namespace details_
    {
        ...
        auto sync_config()
        {
            ...
            con.print( std::format( " (i) 同步配置{}.", config_file.good() ? "成功" : "失败" ) );
        ...
        auto open_config_file()
        {
            ...
            con.print( std::format( " (i) 打开配置文件{}.", success ? "成功" : "失败" ) );
            press_any_key_to_return();
            return func_back;
        }
    }
