...
args_opt_debug   = -Og
args_opt_release = -Ofast -flto=auto -fuse-linker-plugin -s -fvisibility=hidden -fno-rtti -fno-exceptions -fno-unwind-tables -fno-asynchronous-unwind-tables -fno-common -ffunction-sections -fdata-sections -Wl,--gc-sections,--strip-all,--as-needed
